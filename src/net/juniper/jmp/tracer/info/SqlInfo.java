...
public class SqlInfo implements Serializable, Cloneable, ILogable, ILifecycle {
	...
	public String toLog(){
		...
		append("resultCount").append(MonitorConstants.LOG_SEP).append(resultCount).append(MonitorConstants.LOG_SEGMENT);
        ...
        append("endts").append(MonitorConstants.LOG_SEP).append(sdf.format(endD));
		return buf.toString();
	}

 ...
 * From p6spy
 */
public class DCallableStatement extends DPreparedStatement implements CallableStatement {
    protected CallableStatement callStmtPassthru;
    protected String callableQuery;

    public DCallableStatement(DecoratorFactory factory, CallableStatement statement, DConnection conn, String query) {
    ...
    public java.sql.Array getArray(int p0) throws java.sql.SQLException {
        return getDecoratorFactory().getArray(callStmtPassthru.getArray(p0),this);
    }
	...
	Statement wrapped = (callStmtPassthru instanceof DStatement) ?
	    ((DStatement) callStmtPassthru).getJDBC() :
	    callStmtPassthru;
